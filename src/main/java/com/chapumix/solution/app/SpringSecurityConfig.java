...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/indexmipres/**").hasAnyRole("ADMIN", "FARMACIA_MIPRES_ENTREGA", "FARMACIA_MIPRES_PROCESADO", "FARMACIA_MIPRES_PARAMETRO_PRINCIPAL", "FARMACIA_MIPRES_PARAMETRO_SECUNDARIO", "FARMACIA_MIPRES_SINCRONIZAR", "FARMACIA_MIPRES_RIPS", "FARMACIA_MIPRES_ANULAR")
		.antMatchers("/pendientesmipres/**").hasAnyRole("ADMIN", "FARMACIA_MIPRES_ENTREGA", "FARMACIA_MIPRES_PROCESADO", "FARMACIA_MIPRES_PARAMETRO_PRINCIPAL", "FARMACIA_MIPRES_PARAMETRO_SECUNDARIO", "FARMACIA_MIPRES_SINCRONIZAR", "FARMACIA_MIPRES_RIPS", "FARMACIA_MIPRES_ANULAR")
		.antMatchers("/procesadosmipres/**").hasAnyRole("ADMIN", "FARMACIA_MIPRES_ENTREGA", "FARMACIA_MIPRES_PROCESADO", "FARMACIA_MIPRES_PARAMETRO_PRINCIPAL", "FARMACIA_MIPRES_PARAMETRO_SECUNDARIO", "FARMACIA_MIPRES_SINCRONIZAR", "FARMACIA_MIPRES_RIPS", "FARMACIA_MIPRES_ANULAR")
		.antMatchers("/ripsmipres/**").hasAnyRole("ADMIN", "FARMACIA_MIPRES_ENTREGA", "FARMACIA_MIPRES_PROCESADO", "FARMACIA_MIPRES_PARAMETRO_PRINCIPAL", "FARMACIA_MIPRES_PARAMETRO_SECUNDARIO", "FARMACIA_MIPRES_SINCRONIZAR", "FARMACIA_MIPRES_RIPS", "FARMACIA_MIPRES_ANULAR")
		...
		.antMatchers("/tokenformprimario/**").hasAnyRole("ADMIN", "FARMACIA_MIPRES_ENTREGA", "FARMACIA_MIPRES_PROCESADO", "FARMACIA_MIPRES_PARAMETRO_PRINCIPAL", "FARMACIA_MIPRES_PARAMETRO_SECUNDARIO", "FARMACIA_MIPRES_SINCRONIZAR", "FARMACIA_MIPRES_RIPS", "FARMACIA_MIPRES_ANULAR")
		.antMatchers("/tokenformsecundario/**").hasAnyRole("ADMIN", "FARMACIA_MIPRES_ENTREGA", "FARMACIA_MIPRES_PROCESADO", "FARMACIA_MIPRES_PARAMETRO_PRINCIPAL", "FARMACIA_MIPRES_PARAMETRO_SECUNDARIO", "FARMACIA_MIPRES_SINCRONIZAR", "FARMACIA_MIPRES_RIPS", "FARMACIA_MIPRES_ANULAR") 
