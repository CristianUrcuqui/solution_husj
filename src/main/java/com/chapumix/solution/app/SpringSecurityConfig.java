...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/indexmipres/**").hasAnyRole("ADMIN", "FARMACIA_MIPRES_ENTREGA", "FARMACIA_MIPRES_PROCESADO", "FARMACIA_MIPRES_PARAMETRO_PRINCIPAL", "FARMACIA_MIPRES_PARAMETRO_SECUNDARIO", "FARMACIA_MIPRES_SINCRONIZAR")
		.antMatchers("/pendientesmipres/**").hasAnyRole("ADMIN", "FARMACIA_MIPRES_ENTREGA", "FARMACIA_MIPRES_PROCESADO", "FARMACIA_MIPRES_PARAMETRO_PRINCIPAL", "FARMACIA_MIPRES_PARAMETRO_SECUNDARIO", "FARMACIA_MIPRES_SINCRONIZAR")
		.antMatchers("/procesadosmipres/**").hasAnyRole("ADMIN", "FARMACIA_MIPRES_ENTREGA", "FARMACIA_MIPRES_PROCESADO", "FARMACIA_MIPRES_PARAMETRO_PRINCIPAL", "FARMACIA_MIPRES_PARAMETRO_SECUNDARIO", "FARMACIA_MIPRES_SINCRONIZAR")
		.antMatchers("/sincronizaprescripcionform/**").hasAnyRole("ADMIN", "FARMACIA_MIPRES_ENTREGA", "FARMACIA_MIPRES_PROCESADO", "FARMACIA_MIPRES_PARAMETRO_PRINCIPAL", "FARMACIA_MIPRES_PARAMETRO_SECUNDARIO", "FARMACIA_MIPRES_SINCRONIZAR", "FARMACIA_MIPRES_SINCRONIZAR_FECHA", "FARMACIA_MIPRES_SINCRONIZAR_PRESCRIPCION")
		.antMatchers("/tokenformprimario/**").hasAnyRole("ADMIN", "FARMACIA_MIPRES_ENTREGA", "FARMACIA_MIPRES_PROCESADO", "FARMACIA_MIPRES_PARAMETRO_PRINCIPAL", "FARMACIA_MIPRES_PARAMETRO_SECUNDARIO", "FARMACIA_MIPRES_SINCRONIZAR")
		.antMatchers("/tokenformsecundario/**").hasAnyRole("ADMIN", "FARMACIA_MIPRES_ENTREGA", "FARMACIA_MIPRES_PROCESADO", "FARMACIA_MIPRES_PARAMETRO_PRINCIPAL", "FARMACIA_MIPRES_PARAMETRO_SECUNDARIO", "FARMACIA_MIPRES_SINCRONIZAR") 
